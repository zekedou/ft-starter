...
import { CanvasVideo, Sprite, Text } from 'ft/display'
...
class ExampleCanvasVideo extends Scene {
  constructor(name) {
    super(name)
    ...
    const url = app.rm.url('video.record', { type: 'mpegts' })
    const video = new CanvasVideo(url, options)
...
export default ExampleCanvasVideo
